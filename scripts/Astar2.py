...
##################################################################
rospy.init_node('Planning_2', anonymous=False)
pub = rospy.Publisher('Planning_Output2', Int32MultiArray)
...
while map.size == 1:
    rospy.Subscriber('rob2_map', Int32MultiArray, map_subscriber)
    rospy.sleep (2)
