...
rospy.init_node('Planning_4', anonymous=False)
pub = rospy.Publisher('Planning_Output4', Int32MultiArray)
...
while map.size == 1:
    rospy.Subscriber('rob4_map', Int32MultiArray, map_subscriber)
    rospy.sleep (2)
